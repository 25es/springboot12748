    ...
    <div v-if="showFlag">
        ...
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '学号' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search"
                      v-model="searchForm.xuehao" placeholder="学号" clearable></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search"
                      v-model="searchForm.xuehao" placeholder="学号" clearable></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.xuehao" placeholder="学号"
                      clearable></el-input>
          </el-form-item>
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '性别' : ''">
            ...
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search"
                      v-model="searchForm.xingbie" placeholder="性别" clearable></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.xingbie" placeholder="性别"
                      clearable></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                  ...
                  v-if="isAuth('shetuanrenyuanxinxi','查看')"
                  :data="dataList"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              ...
              <el-button
                  v-if="isAuth('xuesheng','转让') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="primary" icon="el-icon-edit" size="mini" @click="shezhangTransfer(scope.row.xuehao)">
                {{ contents.tableBtnFont == 1 ? '转让' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('xuesheng','转让') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
                  type="primary" size="mini" @click="shezhangTransfer(scope.row.xuehao)">
                {{ contents.tableBtnFont == 1 ? '转让' : '' }}<i class="el-icon-edit el-icon--right"/></el-button>
              <el-button v-if="isAuth('xuesheng','转让') && contents.tableBtnIcon == 0" type="primary" size="mini"
                         @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>
...
export default {
  ...
  methods: {
    ...
    //社长转让
    shezhangTransfer(xuehao) {
      this.shezhangtransfer = true;
      this.$confirm('确定是否将社长转让给该学生', '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(action => {
        this.$http({
          url: "shetuanzhuanrang/transfer",
          method: "post",
          data: xuehao
        }).then(({data}) => {
          if (data && data.code === 0) {
            this.$message({
              message: "已成功提交转让信息，请联系管理员审核!",
              type: "success",
              duration: 1500,
              onClose: () => {
                this.search();
