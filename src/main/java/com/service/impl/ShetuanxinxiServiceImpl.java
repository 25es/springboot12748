...
public class ShetuanxinxiServiceImpl extends ServiceImpl<ShetuanxinxiDao, ShetuanxinxiEntity> implements ShetuanxinxiService {
	...
	@Override
	public List<ShetuanxinxiAddActivityItemVO> selectListVO(Wrapper<ShetuanxinxiEntity> wrapper) {
 		return baseMapper.selectListVO(wrapper);
	}
	
	@Override
	public ShetuanxinxiAddActivityItemVO selectVO(Wrapper<ShetuanxinxiEntity> wrapper) {
