...
public interface ShetuanxinxiDao extends BaseMapper<ShetuanxinxiEntity> {
	...
	List<ShetuanxinxiAddActivityItemVO> selectListVO(@Param("ew") Wrapper<ShetuanxinxiEntity> wrapper);
	
	ShetuanxinxiAddActivityItemVO selectVO(@Param("ew") Wrapper<ShetuanxinxiEntity> wrapper);
