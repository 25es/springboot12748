...
public class ForumController {
    ...
    public R query(ForumEntity forum){
		...
		return R.ok("查询社团论坛成功").put("data", forumView);
    }
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
    	...
    	forum.setUserid((Long)request.getSession().getAttribute("userId"));
        EntityWrapper<XueshengEntity> entityEntityWrapper = new EntityWrapper<XueshengEntity>();
        entityEntityWrapper.eq("id",(Long)request.getSession().getAttribute("userId"));
        XueshengVO xueshengVO = xueshengService.selectVO(entityEntityWrapper);
        EntityWrapper<ShetuanshenqingEntity> shetuanshenqingEntityEntityWrapper = new EntityWrapper<ShetuanshenqingEntity>();
        shetuanshenqingEntityEntityWrapper.eq("xuehao",xueshengVO.getXuehao())
                .eq("sfsh","是");
        ShetuanshenqingVO shetuanshenqingVO = shetuanshenqingService.selectVO(shetuanshenqingEntityEntityWrapper);
        if(shetuanshenqingVO == null){
            forum.setShetuanmingzi("无");
        }else {
            forum.setShetuanmingzi(shetuanshenqingVO.getShetuanmingcheng());
        }
        forum.setXueshengxingming(xueshengVO.getXueshengxingming());
    ...
    public R add(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        shetuanshenqingEntityEntityWrapper.eq("xuehao",xueshengVO.getXuehao())
                .eq("sfsh","是");
        ShetuanshenqingVO shetuanshenqingVO = shetuanshenqingService.selectVO(shetuanshenqingEntityEntityWrapper);
        if(shetuanshenqingVO == null || shetuanshenqingVO.getShetuanmingcheng() == null){
            forum.setShetuanmingzi("无");
        }else {
            forum.setShetuanmingzi(shetuanshenqingVO.getShetuanmingcheng());
        }
        forum.setXuehao(xueshengVO.getXuehao());
        forum.setXueshengxingming(xueshengVO.getXueshengxingming());
        forumService.insert(forum);
        return R.ok();
    }
