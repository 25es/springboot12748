...
public class ShetuanhuodongController {
    ...
    public R isjoin(@RequestParam Map<String, Object> params) {
        ...
        try {
            ShetuanxinxiEntity s = shetuanxinxiService.selectOne(
                    new EntityWrapper<ShetuanxinxiEntity>().eq("zhanghao", params.get("zhanghao")));
            String shetuanmingcheng = s.getShetuanmingcheng();
            ...
            return R.error(20000, "您不是当前社团成员");
        }
