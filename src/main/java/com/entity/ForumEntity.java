...
public class ForumEntity<T> implements Serializable {
	...
	public String getShetuanmingzi() {
		return shetuanmingzi;
	}

	public void setShetuanmingzi(String shetuanmingzi) {
		this.shetuanmingzi = shetuanmingzi;
	}
